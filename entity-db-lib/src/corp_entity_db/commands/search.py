...
def db_search_people_perf_test(
    ...
    test_queries_by_type: dict[str, list[tuple[str, str, dict[str, str]]]] = {
        "executive": [
            ...
            ("David Solomon", "David Solomon", {"person_type": "executive", "role": "CEO", "org": "Goldman Sachs"}),
            ...
            ("Jeff Bezos", "Jeff Bezos", {"person_type": "executive"}),
            ("Bill Gates", "Bill Gates", {"person_type": "executive"}),
            ("Larry Page", "Larry Page", {"person_type": "executive"}),
            ("Sergey Brin", "Sergey Brin", {"person_type": "executive"}),
            ("Jack Dorsey", "Jack Dorsey", {"person_type": "executive"}),
            ("Reid Hoffman", "Reid Hoffman", {"person_type": "executive"}),
            ("Peter Thiel", "Peter Thiel", {"person_type": "executive"}),
            ("Travis Kalanick", "Travis Kalanick", {"person_type": "executive"}),
            ("Brian Chesky", "Brian Chesky", {"person_type": "executive"}),
            ("Jack Ma", "Jack Ma", {"person_type": "executive"}),
            ("Richard Branson", "Richard Branson", {"person_type": "executive"}),
            ("Sam Altman", "Sam Altman", {"person_type": "executive"}),
            ("Evan Spiegel", "Evan Spiegel", {"person_type": "executive"}),
            ("Daniel Ek", "Daniel Ek", {"person_type": "executive"}),
            ("Patrick Collison", "Collison", {"person_type": "executive"}),
            ("Whitney Wolfe Herd", "Whitney Wolfe Herd", {"person_type": "executive"}),
            ("Stewart Butterfield", "Stewart Butterfield", {"person_type": "executive"}),
            ("Drew Houston", "Drew Houston", {"person_type": "executive"}),
            ("Tony Hsieh", "Tony Hsieh", {"person_type": "executive"}),
            ("Steve Jobs", "Steve Jobs", {"person_type": "executive"}),
        ],
        "politician": [
            ...
            ("Pedro Sánchez", "Pedro Sánchez", {"person_type": "politician", "role": "Prime Minister", "org": "Spain"}),
            ("Anthony Albanese", "Anthony Albanese", {"person_type": "politician", "role": "Prime Minister", "org": "Australia"}),
            ("Giorgia Meloni", "Giorgia Meloni", {"person_type": "politician", "role": "Prime Minister", "org": "Italy"}),
            ("Luiz Inácio Lula da Silva", "Luiz Inácio Lula da Silva", {"person_type": "politician", "role": "President", "org": "Brazil"}),
            ("Jacinda Ardern", "Jacinda Ardern", {"person_type": "politician", "role": "Prime Minister", "org": "New Zealand"}),
            ("Xi Jinping", "Xi Jinping", {"person_type": "politician", "role": "President", "org": "China"}),
            ("Recep Tayyip Erdoğan", "Recep Tayyip Erdoğan", {"person_type": "politician", "role": "President", "org": "Turkey"}),
            ("Benjamin Netanyahu", "Benjamin Netanyahu", {"person_type": "politician", "role": "Prime Minister", "org": "Israel"}),
            ("Yoon Suk Yeol", "Yoon Suk Yeol", {"person_type": "legal", "role": "President", "org": "South Korea"}),
            ("Mark Rutte", "Mark Rutte", {"person_type": "politician", "role": "Prime Minister", "org": "Netherlands"}),
            ("Keir Starmer", "Keir Starmer", {"person_type": "politician", "role": "Prime Minister", "org": "United Kingdom"}),
        ],
        "government": [
            ("Janet Yellen", "Janet Yellen", {"person_type": "government", "role": "Secretary of the Treasury", "org": "United States"}),
            ("Antony Blinken", "Antony Blinken", {"person_type": "government", "role": "Secretary of State", "org": "United States"}),
            ("Jerome Powell", "Jerome Powell", {"person_type": "government", "role": "Chair", "org": "Federal Reserve"}),
            ("Christine Lagarde", "Christine Lagarde", {"person_type": "government", "role": "President", "org": "European Central Bank"}),
            ("Ursula von der Leyen", "Ursula von der Leyen", {"person_type": "government", "role": "President", "org": "European Commission"}),
            ("António Guterres", "António Guterres", {"person_type": "government", "role": "Secretary-General", "org": "United Nations"}),
            ("Tedros Adhanom Ghebreyesus", "Tedros Adhanom Ghebreyesus", {"person_type": "government", "role": "Director-General", "org": "WHO"}),
            ("Kristalina Georgieva", "Kristalina Georgieva", {"person_type": "government", "role": "Managing Director", "org": "IMF"}),
            ("Gary Gensler", "Gary Gensler", {"person_type": "government", "role": "Chair", "org": "SEC"}),
            ("Merrick Garland", "Merrick Garland", {"person_type": "government", "role": "Attorney General", "org": "United States"}),
            ("Andrew Bailey", "Andrew Bailey", {"person_type": "government", "role": "Governor", "org": "Bank of England"}),
            ("Haruhiko Kuroda", "Haruhiko Kuroda", {"person_type": "government", "role": "Governor", "org": "Bank of Japan"}),
            ("Lloyd Austin", "Lloyd J. Austin III", {"person_type": "government", "role": "Secretary of Defense", "org": "United States"}),
            ("Avril Haines", "Avril Haines", {"person_type": "government", "role": "Director of National Intelligence", "org": "United States"}),
            ("Alejandro Mayorkas", "Alejandro Mayorkas", {"person_type": "government", "role": "Secretary", "org": "DHS"}),
            ("Gina Raimondo", "Gina Raimondo", {"person_type": "government", "role": "Secretary of Commerce", "org": "United States"}),
            ("Janet Woodcock", "Janet Woodcock", {"person_type": "government", "role": "Commissioner", "org": "FDA"}),
            ("Ajay Banga", "Ajay K Banga", {"person_type": "government", "role": "President", "org": "World Bank"}),
            ("Ngozi Okonjo-Iweala", "Ngozi Okonjo-Iweala", {"person_type": "government", "role": "Director-General", "org": "WTO"}),
            ("Charles Michel", "Charles Michel", {"person_type": "government", "role": "President", "org": "European Council"}),
        ],
        "military": [
            ("Mark A. Milley", "Mark A. Milley", {"person_type": "military", "role": "Chairman Joint Chiefs of Staff", "org": "United States"}),
            ("Valerii Zaluzhnyi", "Valerii Zaluzhnyi", {"person_type": "military", "role": "Commander-in-Chief", "org": "Ukraine Armed Forces"}),
            ...
            ("Rob Bauer", "Rob Bauer", {"person_type": "military", "role": "Chair", "org": "NATO Military Committee"}),
            ("Christopher Cavoli", "Christopher G. Cavoli", {"person_type": "military", "role": "SACEUR", "org": "NATO"}),
            ("Michael Kurilla", "Michael Kurilla", {"person_type": "military", "role": "Commander", "org": "CENTCOM"}),
            ("Charles Q. Brown Jr", "Charles Q. Brown", {"person_type": "military", "role": "Chairman Joint Chiefs of Staff", "org": "United States"}),
            ("Eberhard Zorn", "Eberhard Zorn", {"person_type": "military", "role": "Inspector General", "org": "Germany Bundeswehr"}),
            ("Koji Yamazaki", "Koji Yamazaki", {"person_type": "military", "role": "Chief of Staff", "org": "Japan Self-Defense Forces"}),
            ("Angus Campbell", "Angus Campbell", {"person_type": "military", "role": "Chief of Defence Force", "org": "Australia"}),
            ...
            ("Sergei Shoigu", "Sergei Shoigu", {"person_type": "military", "role": "Minister of Defence", "org": "Russia"}),
            ("James Hecker", "James Hecker", {"person_type": "military", "role": "Commander", "org": "US Air Forces in Europe"}),
            ("Samuel Paparo", "Samuel Paparo", {"person_type": "military", "role": "Commander", "org": "US Indo-Pacific Command"}),
            ("Laura Richardson", "Laura J. Richardson", {"person_type": "military", "role": "Commander", "org": "US Southern Command"}),
            ("Mauro Del Vecchio", "Mauro Del Vecchio", {"person_type": "military", "role": "Commander", "org": "NATO Joint Force Command"}),
            ("Stuart Peach", "Stuart Peach", {"person_type": "military", "role": "Chair", "org": "NATO Military Committee"}),
            ("Eirik Kristoffersen", "Eirik Kristoffersen", {"person_type": "military", "role": "Chief of Defence", "org": "Norway"}),
        ],
        "legal": [
            ("John Roberts", "John Roberts", {"person_type": "legal", "role": "Chief Justice", "org": "Supreme Court of the United States"}),
            ("Sonia Sotomayor", "Sonia Sotomayor", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Ketanji Brown Jackson", "Ketanji Brown Jackson", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Clarence Thomas", "Clarence Thomas", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Elena Kagan", "Elena Kagan", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Neil Gorsuch", "Neil Gorsuch", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Brett Kavanaugh", "Brett Kavanaugh", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Amy Coney Barrett", "Amy Coney Barrett", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Samuel Alito", "Samuel Alito", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Ruth Bader Ginsburg", "Ruth Bader Ginsburg", {"person_type": "legal", "role": "Justice", "org": "Supreme Court of the United States"}),
            ("Brenda Hale", "Brenda Hale", {"person_type": "legal", "role": "President", "org": "Supreme Court, United Kingdom"}),
            ("Robert Reed", "Robert Reed", {"person_type": "legal", "role": "President", "org": "UK Supreme Court"}),
            ("Karim Khan", "Karim Khan", {"person_type": "legal", "role": "Prosecutor", "org": "International Criminal Court"}),
            ("Joan Donoghue", "Joan Donoghue", {"person_type": "legal", "role": "President", "org": "International Court of Justice"}),
            ("Didier Reynders", "Didier Reynders", {"person_type": "legal", "role": "Commissioner for Justice", "org": "European Commission"}),
            ("Fatou Bensouda", "Fatou Bensouda", {"person_type": "legal", "role": "Prosecutor", "org": "International Criminal Court"}),
            ("Loretta Lynch", "Loretta Lynch", {"person_type": "legal", "role": "Attorney General", "org": "United States"}),
            ("Eric Holder", "Eric Holder", {"person_type": "legal", "role": "Attorney General", "org": "United States"}),
            ("Robert Mueller", "Robert Mueller", {"person_type": "legal", "role": "Special Counsel", "org": "Department of Justice"}),
            ("Jack Smith", "Jack Smith", {"person_type": "legal", "role": "Special Counsel", "org": "Department of Justice"}),
        ],
        "professional": [
            ("Atul Gawande", "Atul Gawande", {"person_type": "professional", "role": "surgeon", "org": "Brigham and Women's Hospital"}),
            ("Sanjay Gupta", "Sanjay Gupta", {"person_type": "professional", "role": "neurosurgeon", "org": "Emory University Hospital"}),
            ("Anthony Fauci", "Anthony Fauci", {"person_type": "professional", "role": "immunologist", "org": "NIAID"}),
            ("Devi Shetty", "Devi Shetty", {"person_type": "professional", "role": "cardiac surgeon", "org": "Narayana Health"}),
            ...
            ("Frank Gehry", "Frank Gehry", {"person_type": "professional", "role": "architect", "org": "Gehry Partners"}),
            ("Tadao Ando", "Tadao Ando", {"person_type": "professional", "role": "architect"}),
            ("I. M. Pei", "I. M. Pei", {"person_type": "unknown", "role": "architect", "org": "Pei Cobb Freed"}),
            ("Santiago Calatrava", "Santiago Calatrava", {"person_type": "professional", "role": "architect"}),
            ("Rem Koolhaas", "Rem Koolhaas", {"person_type": "professional", "role": "architect", "org": "OMA"}),
            ("Thomas Heatherwick", "Thomas Heatherwick", {"person_type": "professional", "role": "designer", "org": "Heatherwick Studio"}),
            ("Jony Ive", "Jony Ive", {"person_type": "professional", "role": "designer", "org": "Apple"}),
            ("Dieter Rams", "Dieter Rams", {"person_type": "professional", "role": "designer", "org": "Braun"}),
            ("Philippe Starck", "Philippe Starck", {"person_type": "professional", "role": "designer"}),
            ("Toyo Ito", "Toyo Ito", {"person_type": "unknown", "role": "architect"}),
            ("Daniel Libeskind", "Daniel Libeskind", {"person_type": "professional", "role": "architect"}),
            ("Peter Zumthor", "Peter Zumthor", {"person_type": "professional", "role": "architect"}),
        ],
        "academic": [
            ("Noam Chomsky", "Noam Chomsky", {"person_type": "academic", "role": "professor", "org": "MIT"}),
            ("Steven Pinker", "Steven Pinker", {"person_type": "academic", "role": "professor", "org": "Harvard"}),
            ("Paul Krugman", "Paul Krugman", {"person_type": "academic", "role": "professor", "org": "Princeton"}),
            ("Joseph Stiglitz", "Joseph E. Stiglitz", {"person_type": "academic", "role": "professor", "org": "Columbia"}),
            ("Thomas Piketty", "Thomas Piketty", {"person_type": "academic", "role": "professor", "org": "Paris School of Economics"}),
            ("Yuval Noah Harari", "Yuval Noah Harari", {"person_type": "academic", "role": "professor", "org": "Hebrew University"}),
            ("Niall Ferguson", "Niall Ferguson", {"person_type": "academic", "role": "professor", "org": "Stanford"}),
            ("Lawrence Lessig", "Lawrence Lessig", {"person_type": "academic", "role": "professor", "org": "Harvard Law School"}),
            ("Cornel West", "Cornel West", {"person_type": "academic", "role": "professor", "org": "Union Theological Seminary"}),
            ("Nassim Nicholas Taleb", "Nassim Nicholas Taleb", {"person_type": "academic", "role": "professor", "org": "NYU"}),
            ("Jordan Peterson", "Jordan Peterson", {"person_type": "academic", "role": "professor", "org": "University of Toronto"}),
            ("Richard Dawkins", "Richard Dawkins", {"person_type": "academic", "role": "professor", "org": "Oxford"}),
            ("Amy Cuddy", "Amy Cuddy", {"person_type": "academic", "role": "professor", "org": "Harvard Business School"}),
            ("Brené Brown", "Brené Brown", {"person_type": "academic", "role": "professor", "org": "University of Houston"}),
            ("Henry Kissinger", "Henry Kissinger", {"person_type": "academic", "role": "professor", "org": "Georgetown"}),
            ("Daron Acemoğlu", "Daron Acemoğlu", {"person_type": "academic", "role": "professor", "org": "MIT"}),
            ("Tyler Cowen", "Tyler Cowen", {"person_type": "academic", "role": "professor", "org": "George Mason University"}),
            ("Esther Duflo", "Esther Duflo", {"person_type": "academic", "role": "professor", "org": "MIT"}),
            ("Abhijit Banerjee", "Abhijit Banerjee", {"person_type": "academic", "role": "professor", "org": "MIT"}),
            ("Jeffrey Sachs", "Jeffrey Sachs", {"person_type": "academic", "role": "professor", "org": "Columbia"}),
            # Scientists (merged from scientist type)
            ("Albert Einstein", "Albert Einstein", {"person_type": "academic", "role": "physicist", "org": "Princeton"}),
            ("Stephen Hawking", "Stephen Hawking", {"person_type": "academic", "role": "physicist", "org": "University of Cambridge"}),
            ("Marie Curie", "Marie Curie", {"person_type": "academic", "role": "physicist"}),
            ("Jennifer Doudna", "Jennifer Doudna", {"person_type": "academic", "role": "biochemist", "org": "UC Berkeley"}),
            ("Emmanuelle Charpentier", "Emmanuelle Charpentier", {"person_type": "academic", "role": "microbiologist"}),
            ("Katalin Karikó", "Katalin Karikó", {"person_type": "academic", "role": "biochemist", "org": "BioNTech"}),
            ("Demis Hassabis", "Demis Hassabis", {"person_type": "academic", "role": "AI researcher", "org": "DeepMind"}),
            ("Geoffrey Hinton", "Geoffrey Hinton", {"person_type": "academic", "role": "computer scientist"}),
            ("Yann LeCun", "Yann Le Cun", {"person_type": "academic", "role": "AI researcher", "org": "Meta"}),
            ("Yoshua Bengio", "Yoshua Bengio", {"person_type": "academic", "role": "computer scientist", "org": "Mila"}),
            ("Andrew Ng", "Andrew Ng", {"person_type": "academic", "role": "computer scientist", "org": "Stanford"}),
            ("Fei-Fei Li", "Fei-Fei Li", {"person_type": "academic", "role": "computer scientist", "org": "Stanford"}),
            ("Neil deGrasse Tyson", "Neil deGrasse Tyson", {"person_type": "academic", "role": "astrophysicist", "org": "Hayden Planetarium"}),
            ("Jane Goodall", "Jane Goodall", {"person_type": "academic", "role": "primatologist"}),
            ("Francis Collins", "Francis Collins", {"person_type": "academic", "role": "geneticist", "org": "NIH"}),
            ("Kip Thorne", "Kip S. Thorne", {"person_type": "academic", "role": "physicist", "org": "Caltech"}),
            ("Roger Penrose", "Roger Penrose", {"person_type": "academic", "role": "mathematician", "org": "Oxford"}),
            ("Tu Youyou", "Tu Youyou", {"person_type": "academic", "role": "pharmacologist"}),
            ("James Watson", "James Watson", {"person_type": "academic", "role": "molecular biologist"}),
            ("Tim Berners-Lee", "Berners-Lee", {"person_type": "academic", "role": "computer scientist"}),
        ],
        "artist": [
            ("Taylor Swift", "Taylor Swift", {"person_type": "artist"}),
            ("Beyoncé", "Beyoncé", {"person_type": "artist"}),
        ...
        "athlete": [
            ...
            ("Patrick Mahomes", "Patrick Mahomes", {"person_type": "athlete"}),
            ("Kylian Mbappé", "Kylian Mbappé", {"person_type": "athlete"}),
            ("Erling Haaland", "Erling Haaland", {"person_type": "athlete"}),
            ("Stephen Curry", "Stephen Curry", {"person_type": "athlete"}),
            ("Naomi Osaka", "Naomi Osaka", {"person_type": "athlete"}),
            ("Katie Ledecky", "Katie Ledecky", {"person_type": "athlete"}),
            ("Eliud Kipchoge", "Eliud Kipchoge", {"person_type": "athlete"}),
            ("Neymar", "Neymar", {"person_type": "athlete"}),
        ],
        "journalist": [
            ("Anderson Cooper", "Anderson Cooper", {"person_type": "journalist", "role": "anchor", "org": "CNN"}),
            ("Christiane Amanpour", "Christiane Amanpour", {"person_type": "journalist", "role": "journalist", "org": "CNN"}),
            ...
            ("Maggie Haberman", "Maggie Haberman", {"person_type": "journalist", "role": "journalist", "org": "New York Times"}),
        ...
        "activist": [
            ...
            ("Malala Yousafzai", "Malala Yousafzai", {"person_type": "activist"}),
            ...
            ("Wangari Muta Maathai", "Wangari Muta Maathai", {"person_type": "politician"}),
            ...
            ("Patrisse Cullors", "Patrisse Khan-Cullors", {"person_type": "activist"}),
            ("Luisa Neubauer", "Luisa Neubauer", {"person_type": "media"}),
            ("Joshua Wong", "Joshua Wong", {"person_type": "activist"}),
            ("Alexei Navalny", "Alexei Navalny", {"person_type": "activist"}),
            ("Aung San Suu Kyi", "Suu Kyi", {"person_type": "politician"}),
