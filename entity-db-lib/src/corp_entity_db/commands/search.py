...
def db_people_test(
    ...
    test_queries_by_type: dict[str, list[tuple[str, str, dict[str, str]]]] = {
        ...
        "military": [
            ...
            ("Laura Richardson", "Laura J. Richardson", {"person_type": "military", "role": "Commander", "org": "US Southern Command", "expected_type": "unknown", "expected_org": ""}),
        ...
        "legal": [
            ...
            ("Robert Mueller", "Robert Mueller", {"person_type": "legal", "role": "Special Counsel", "org": "Department of Justice", "expected_type": "unknown", "expected_org": ""}),
        ...
        "professional": [
            ...
            ("Sanjay Gupta", "Sanjay Gupta", {"person_type": "professional", "role": "neurosurgeon", "org": "Emory University Hospital", "expected_type": "academic", "expected_org": ""}),
        ...
        "academic": [
            ...
            ("Richard Dawkins", "Richard Dawkins", {"person_type": "academic", "role": "professor", "org": "Oxford", "expected_type": "unknown", "expected_org": ""}),
            ...
            ("Abhijit Banerjee", "Abhijit Banerjee", {"person_type": "academic", "role": "professor", "org": "MIT", "expected_type": "academic", "expected_org": ""}),
            ...
            ("Jane Goodall", "Jane Goodall", {"person_type": "academic", "role": "primatologist", "expected_type": "unknown"}),
            ("Francis Collins", "Francis Collins", {"person_type": "academic", "role": "geneticist", "org": "NIH", "expected_type": "unknown", "expected_org": ""}),
            ...
            ("James Watson", "James Watson", {"person_type": "academic", "role": "molecular biologist", "expected_type": "unknown"}),
        ...
        "activist": [
            ...
            ("Desmond Tutu", "Desmond Tutu", {"person_type": "activist", "role": "archbishop", "expected_type": "athlete"}),
            ("Gloria Steinem", "Gloria Steinem", {"person_type": "activist", "role": "feminist activist", "expected_type": "journalist"}),
            ("Angela Davis", "Angela Davis", {"person_type": "activist", "role": "civil rights activist", "expected_type": "media"}),
            ...
            ("Joshua Wong", "Joshua Wong", {"person_type": "activist", "role": "pro-democracy activist", "expected_type": "journalist"}),
            ...
            ("Cesar Chavez", "Cesar Chavez", {"person_type": "activist", "role": "labor leader", "expected_type": "politician"}),
        ],
    }
